...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const briefTranscript =
      ...
      `【全片要求】严格 5 个 3 秒镜头:钩子 1 镜 + 递进种草 3 镜 + CTA 1 镜。主角始终是上面那位虚构博主(同人同发型同服装),每镜都有动作(指/拿/试/转身/对镜头说话);**每一镜都必须有 dialogue 和 subtitle,严禁空台词**,每段建议 8–18 个汉字,五句合计 60–72 个汉字(硬上限 72,宁短勿长,严禁为了凑字数重复内容、重复短语或回读),用中文逗号连接后就是一条从约 0.2 秒持续到约 14.5 秒的完整口播。五段分别讲钩子 → 进店发现 → 商品细节 → 价值体验 → 行动召唤,画面、对白、字幕必须逐段对应。语速自然偏快且清晰(约每分钟 270–320 汉字),逗号处允许 0.15–0.35 秒自然换气,切镜时人声延续不重开。随机变化钩子、人设和表达,但主旨永远是强力种草当前门店;门店事实和卖点只能来自店铺画像、品牌知识库与已选实景素材,严禁编造价格或活动。博主每一镜都要有情绪推进,全部用上传的店内实景;结尾必须带 CTA(参考博主 CTA「${persona.cta}」)。`;
