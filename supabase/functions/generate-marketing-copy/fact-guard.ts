...
硬性禁止：
  1. 任何未在已核实事实中出现的数字、数量、面积、库存、人数、年份、排名。
  2. 任何价格、价位、折扣、优惠、活动信息，以及“便宜/平价/几块钱/白菜价/预算友好”这类价格判断——一个字都不许写。
  3. 点名任何第三方品牌、IP、动漫/玩具角色名（即使参考图或事实描述里出现过，也一律不许写出名字），只能用“中古玩具/玩偶/杂货/餐具/挂钟/陶瓷杯碟”等通用词描述。
  4. 只允许出现这些品牌名：${allowed}。
  5. 不得承诺保真、升值、最低价、限时。
