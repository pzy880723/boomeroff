...
export const THIRD_PARTY_BRAND_PATTERNS: { pattern: RegExp; replace: string }[] = [
  // 上海系
  { pattern: /上海\s*中信泰富(广场|店|商场)?/g, replace: '本店' },
  { pattern: /中信泰富(广场|店|商场)?/g, replace: '本店' },
  { pattern: /恒隆(广场|店)?/g, replace: '本店' },
  { pattern: /IFC(?:\s*商场)?/gi, replace: '本店' },
  { pattern: /新天地(店|商场)?/g, replace: '本店' },
  { pattern: /(?:上海)?来福士(广场|店)?/g, replace: '本店' },
  { pattern: /(?:上海)?大悦城(店)?/g, replace: '本店' },
  { pattern: /(?:上海)?K11(?:\s*购物艺术中心)?/gi, replace: '本店' },
  { pattern: /正大广场(店)?/g, replace: '本店' },
  { pattern: /久光(百货|店)?/g, replace: '本店' },
  { pattern: /百联(奥莱|广场|店)?/g, replace: '本店' },
  { pattern: /环贸(?:\s*IAPM)?(店)?/gi, replace: '本店' },
  { pattern: /月星环球港(店)?/g, replace: '本店' },
  { pattern: /陆家嘴中心(店)?/g, replace: '本店' },
  // 北京 / 成都 / 深圳系
  { pattern: /三里屯太古里/g, replace: '本店' },
  { pattern: /(成都|北京)?太古里/g, replace: '本店' },
  { pattern: /(北京|成都|深圳|上海)?SKP(?:-S)?/g, replace: '本店' },
  { pattern: /国贸(商城|店)?/g, replace: '本店' },
  { pattern: /(华润)?万象城/g, replace: '本店' },
  { pattern: /(华润)?万象汇/g, replace: '本店' },
  { pattern: /(华润)?万象天地/g, replace: '本店' },
  { pattern: /印力(购物中心)?/g, replace: '本店' },
  { pattern: /龙湖天街/g, replace: '本店' },
  { pattern: /龙湖\s*[\u4e00-\u9fa5]{0,4}天街/g, replace: '本店' },
  { pattern: /大悦春风里/g, replace: '本店' },
  { pattern: /合生汇/g, replace: '本店' },
  { pattern: /银泰(城|百货|中心)?/g, replace: '本店' },
  { pattern: /万达广场/g, replace: '本店' },
  { pattern: /凯德(广场|Mall)?/gi, replace: '本店' },
  { pattern: /环宇城/g, replace: '本店' },
  { pattern: /(?:广州|深圳|北京|上海)?太古(?:汇|广场|里)/g, replace: '本店' },
  // 通用兜底:"XX 广场店 / XX 商场店 / XX 中心店"这种真实招牌尾缀
  { pattern: /[\u4e00-\u9fa5A-Za-z0-9]{2,8}(广场|商场|购物中心|商城|中心)店/g, replace: '本店' },
