  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-md px-2">
        <ul className="flex items-end justify-around h-14 relative">
            ...
            if (primary) {
              return (
                <li key={to} className="flex-1 flex justify-center">
                  <NavLink
                    to={to}
                    className="flex flex-col items-center justify-center gap-0.5 h-full pt-1 pb-1"
                    aria-label={label}
                  >
                    <span
                      className={cn(
            ...
            return (
              <li key={to} className="flex-1">
                <NavLink
                  to={to}
                  className={cn(
                    'flex flex-col items-center justify-center gap-0.5 h-full pt-1 pb-1 transition-colors',
