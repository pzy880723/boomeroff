    ...
    <div className="space-y-3">
      ...
      <SectionCard className="overflow-hidden" delay={0} onClick={() => navigate('/me')}>
        <div className="p-4 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[10px] tracking-[0.2em] text-[hsl(var(--primary-foreground)/0.45)] mb-1">今日班次</div>
            {shift ? (
              <>
              ...
              <>
                ...
                <p className="text-xs text-[hsl(var(--primary-foreground)/0.45)] mt-0.5">好好放松一天</p>
              </>
            )}
          </div>
      ...
      {peers.length > 0 && (
        <SectionCard className="p-4" delay={60}>
          <div className="text-[11px] tracking-[0.18em] text-[hsl(var(--primary-foreground)/0.5)] mb-3">同班同事</div>
            ...
            {peers.map(c => (
              <div key={c.user_id} className="flex flex-col items-center gap-1.5 shrink-0 w-14">
                <div className="relative">
                  ...
                  <span className="absolute bottom-0 right-0 w-3 h-3 rounded-full bg-success border-2 border-[hsl(25_16%_13%)]" />
                </div>
