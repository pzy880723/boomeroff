...
export const APP_ICON_REGISTRY: Record<string, AppIconMeta> = {
  ...
  library:       { id: 'library',       label: '知识库',    to: '/library',       Icon: BookOpen,       tone: 'white' },
  'my-kb':       { id: 'my-kb',         label: '我的知识',   to: '/my-library',    Icon: BookMarked,     tone: 'white' },
  vouchers:      { id: 'vouchers',      label: '我的券包',   to: '/me/vouchers',   Icon: Ticket,         tone: 'white' },
  schedule:      { id: 'schedule',      label: '排班表',    to: '/me',            Icon: CalendarDays,   tone: 'white' },
  checkins:      { id: 'checkins',      label: '打卡记录',   to: '/me/check-ins',  Icon: CalendarCheck,  tone: 'white' },
  sop:           { id: 'sop',           label: '员工手册',   to: '/me/sop',        Icon: FileText,       tone: 'white' },
  qa:            { id: 'qa',            label: '门店问答',   to: '/me/qa',         Icon: HelpCircle,     tone: 'white' },
  okr:           { id: 'okr',           label: '门店管理',   to: '/store/okr',     Icon: Target,         tone: 'white' },
  notifications: { id: 'notifications', label: '通知',      to: '/notifications', Icon: Bell,           tone: 'white' },
  me:            { id: 'me',            label: '我的',      to: '/me',            Icon: User,           tone: 'white' },
  more:          { id: 'more',          label: '更多',      to: '/me',            Icon: MoreHorizontal, tone: 'white' },
};
